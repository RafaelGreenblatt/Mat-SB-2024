...
const results = data.results4;
</script>

# Risultati di appello IV (9 giugno 2025)
...
Gli esami consegnati possono essere consultati su appuntamento.  La conclusione della verbalizzazione è prevista per il 20 giugno circa ma questa data puó variare.
