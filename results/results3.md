...
const results = data.results3;
</script>

# Risultati di appello III (20 febbraio 2025)
...
Gli esami consegnati possono essere consultati su appuntamento.  La conclusione della verbalizzazione è prevista per il 3 marzo circa ma questa data puó variare.
